      ...
      <div className="flex-1 flex items-center justify-center p-8 sm:p-16 md:p-16 relative z-10 overflow-y-auto">
        <div className="w-full max-w-md p-10 wwdc-card relative my-8">
          ...
          <div className="space-y-2 mb-6">
            <h3 className="text-3xl font-bold tracking-tight text-slate-900 dark:text-white">Create an Account</h3>
            <p className="text-sm font-medium text-slate-550 dark:text-slate-400">Join the ERP platform as an employee</p>
          </div>

          {error && (
            <div className="mb-4 p-3.5 bg-red-50/70 dark:bg-red-950/30 border border-red-200 dark:border-red-900/40 text-red-650 dark:text-red-400 text-xs font-semibold rounded-2xl flex items-center gap-2.5">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            {/* Full Name */}
            <div className="space-y-1">
              <label className="block text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-wider pl-1">Full Name</label>
            ...
            {/* Phone Number */}
            <div className="space-y-1">
              <label className="block text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-wider pl-1">Phone Number (Optional)</label>
              <div className="relative">
                <span className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
            ...
            {/* Password */}
            <div className="space-y-1">
              <label className="block text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-wider pl-1">Password</label>
              <div className="relative">
                <span className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
            ...
            <div className="flex items-start pl-1">
              ...
              <label htmlFor="terms" className="ml-2 block text-xs font-semibold text-slate-550 dark:text-slate-400 select-none leading-relaxed">
                I accept the <Link href="#" className="text-blue-650 dark:text-blue-400 font-bold hover:underline">Terms</Link> and <Link href="#" className="text-blue-650 dark:text-blue-400 font-bold hover:underline">Privacy Policy</Link>.
              </label>
            </div>
          ...
          {/* Bottom links */}
          <div className="mt-6 text-center text-sm text-slate-500 dark:text-slate-400 font-semibold border-t border-slate-100/80 dark:border-slate-800/80 pt-6">
