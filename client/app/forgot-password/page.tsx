      ...
      <div className="flex-1 flex items-center justify-center p-8 sm:p-12 md:p-24 relative z-10">
        <div className="w-full max-w-md p-10 wwdc-card relative">
          ...
          <div className="space-y-2 mb-8">
            ...
            <p className="text-sm font-medium text-slate-500 dark:text-slate-400">Enter your email to retrieve reset credentials</p>
          </div>
          ...
          {!success ? (
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                <label className="block text-[10px] font-bold text-slate-400 dark:text-slate-550 uppercase tracking-wider pl-1">Email Address</label>
            ...
            <div className="space-y-6 text-center">
              <div className="p-4 bg-emerald-50 dark:bg-emerald-950/20 border border-emerald-250 dark:border-emerald-900/50 rounded-xl space-y-3 text-left">
                ...
                {resetToken && (
                  <div className="mt-3">
                    <span className="text-[9px] uppercase font-bold text-slate-450 dark:text-slate-500 block mb-1">Generated Token</span>
          ...
          <div className="mt-8 text-center border-t border-slate-100/80 dark:border-slate-800/80 pt-6">
            <Link href="/login" className="inline-flex items-center gap-1.5 text-xs text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white font-semibold">
